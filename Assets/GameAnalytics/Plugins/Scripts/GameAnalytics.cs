...
# endif
        ...
        private static void InternalInitialize()
        {
            ...
            //Debug.Log("InternalInitialize platformIndex: " +platformIndex + " GameAnalyticsSDK version: " + GameAnalyticsSDK.Setup.Settings.VERSION);
        ...
        {
            InternalInitialize();
            //Debug.Log("InternalInitialize completed");
            int platformIndex = GetPlatformIndex();
